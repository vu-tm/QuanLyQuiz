...
public class Chart extends javax.swing.JPanel {
        ...
        blankPlotChart.setBlankPlotChatRender(new BlankPlotChatRender() {
            ...
            public void renderSeries(BlankPlotChart chart, Graphics2D g2, SeriesSize size, int index) {
                ...
                for (int i = 0; i < legends.size(); i++) {
                    ...
                    GradientPaint gra = new GradientPaint(0, 0, new Color(86, 195, 250), 0,
                            (int) (size.getY() + size.getHeight()), legend.getColor());
                    g2.setPaint(gra);
    ...
    private void initComponents() {
        ...
        blankPlotChart = new GUI.ThongKe.Support.BlankChart.BlankPlotChart();
    ...
    private GUI.ThongKe.Support.BlankChart.BlankPlotChart blankPlotChart;
